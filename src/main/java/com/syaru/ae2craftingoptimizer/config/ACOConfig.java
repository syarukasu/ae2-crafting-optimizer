...
public final class ACOConfig {
    ...
    private static final ModConfigSpec.IntValue ACTIVE_CALCULATION_DEDUPLICATION_MAXIMUM_ENTRIES;
    ...
    private static final ModConfigSpec.BooleanValue LOG_PLANNING_STATISTICS;
