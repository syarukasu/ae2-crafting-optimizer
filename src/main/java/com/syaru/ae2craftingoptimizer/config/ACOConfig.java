...
public final class ACOConfig {
    ...
    private static final ForgeConfigSpec.IntValue INSTANT_PATTERN_DISPATCH_MAXIMUM_UNMEASURED_WAVE_OPERATIONS;
    ...
    private static final ForgeConfigSpec.IntValue MAXIMUM_BATCH_EXECUTIONS;
    ...
    private static final ForgeConfigSpec.BooleanValue REQUIRE_WIDE_PLAN_SHADOW_QUALIFICATION;
    ...
    private static final ForgeConfigSpec.BooleanValue ENABLE_EXACT_PHYSICAL_EXECUTION;
    ...
    public static boolean enableLongRootCraftAmounts() {
        return !Ae2UelmCompatibility.ownsAe2ExtendedAmountSurface()
                && OptimizationFeatureGate.allows(OptimizationFeature.LONG_ROOT_AMOUNTS, ENABLE_LONG_ROOT_CRAFT_AMOUNTS.get());
    }
