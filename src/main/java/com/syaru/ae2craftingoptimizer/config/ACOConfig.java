...
public final class ACOConfig {
    ...
    private static final ModConfigSpec.BooleanValue ENABLE_NETWORK_TOPOLOGY_DOMAIN;
    private static final ModConfigSpec.BooleanValue ENABLE_STORAGE_IO_DOMAIN;
    private static final ModConfigSpec.BooleanValue ENABLE_PATTERN_PROVIDER_DOMAIN;
    private static final ModConfigSpec.BooleanValue ENABLE_CLIENT_SYNC_DOMAIN;
    ...
    private static final ModConfigSpec.BooleanValue TWO_STAGE_MISSING_PREVIEW;
    private static final ModConfigSpec.BooleanValue CANCEL_CALCULATION_AFTER_PRELIMINARY_MISSING_PREVIEW;
    private static final ModConfigSpec.BooleanValue SKIP_CALCULATION_ON_CACHED_MISSING_PREVIEW;
    private static final ModConfigSpec.BooleanValue USE_MISSING_PREVIEW_CACHE;
    private static final ModConfigSpec.IntValue MISSING_PREVIEW_CACHE_SIZE;
    private static final ModConfigSpec.IntValue MISSING_PREVIEW_CACHE_TTL_SECONDS;
    private static final ModConfigSpec.BooleanValue INVALIDATE_CACHE_ON_STORAGE_CHANGE;
    private static final ModConfigSpec.BooleanValue INVALIDATE_CACHE_ON_PATTERN_CHANGE;
    private static final ModConfigSpec.IntValue MINIMUM_CALCULATION_MILLIS_FOR_PREVIEW;
    private static final ModConfigSpec.LongValue MINIMUM_REQUESTED_AMOUNT_FOR_PREVIEW;
    private static final ModConfigSpec.IntValue PREVIEW_MAXIMUM_ENTRIES;
    private static final ModConfigSpec.ConfigValue<List<? extends String>> HEAVY_PROCESS_HINTS;
    ...
    private static final ModConfigSpec.IntValue DETERMINISTIC_PREFLIGHT_MAX_NODES;
    private static final ModConfigSpec.BooleanValue LOG_FAST_FAIL_MISSING_CRAFTS;
    ...
    private static final ModConfigSpec.BooleanValue CACHE_CRAFTABLE_SETS;
    private static final ModConfigSpec.IntValue CRAFTABLE_SET_CACHE_SIZE;
    ...
    private static final ModConfigSpec.BooleanValue ENABLE_GRID_TICK_BUDGET;
    private static final ModConfigSpec.BooleanValue DEFER_HEAVY_GRID_TICKABLES;
    private static final ModConfigSpec.IntValue GRID_TICK_BUDGET_MILLIS_PER_SERVER_TICK;
    private static final ModConfigSpec.IntValue GRID_TICK_MINIMUM_INTERVAL_TICKS;
    private static final ModConfigSpec.IntValue SLOW_GRID_TICKABLE_MICROS;
    private static final ModConfigSpec.IntValue SLOW_GRID_TICKABLE_BACKOFF_TICKS;
    private static final ModConfigSpec.BooleanValue BACKOFF_IDLE_GRID_TICKABLES;
    private static final ModConfigSpec.IntValue IDLE_GRID_TICKABLE_BACKOFF_AFTER_FAILURES;
    private static final ModConfigSpec.IntValue IDLE_GRID_TICKABLE_BACKOFF_TICKS;
    private static final ModConfigSpec.ConfigValue<List<? extends String>> HEAVY_GRID_TICKABLE_CLASS_HINTS;
    private static final ModConfigSpec.BooleanValue LIMIT_IO_BUS_OPERATIONS_PER_TICK;
    private static final ModConfigSpec.IntValue MAX_IO_BUS_OPERATIONS_PER_TICK;
    private static final ModConfigSpec.BooleanValue THROTTLE_EXPORT_BUS_CRAFT_REQUESTS;
    private static final ModConfigSpec.IntValue EXPORT_BUS_CRAFT_FAILURE_COOLDOWN_TICKS;
    private static final ModConfigSpec.IntValue EXPORT_BUS_CRAFT_THROTTLE_CACHE_SIZE;
    private static final ModConfigSpec.BooleanValue LOG_GRID_TICK_BUDGET;
    private static final ModConfigSpec.BooleanValue CACHE_ADJACENT_CAPABILITY_LOOKUPS;
    private static final ModConfigSpec.BooleanValue CACHE_ADJACENT_CAPABILITIES_ACROSS_TICKS;
    private static final ModConfigSpec.BooleanValue CACHE_NEGATIVE_BUS_TRANSFER_SIMULATIONS;
    ...
    private static final ModConfigSpec.BooleanValue INCREMENTAL_IO_PORT_PROCESSING;
    private static final ModConfigSpec.IntValue IO_PORT_CELL_SLOTS_PER_TICK;
    private static final ModConfigSpec.BooleanValue CACHE_IMPORT_BUS_LAST_SUCCESSFUL_SLOT;
    private static final ModConfigSpec.BooleanValue CACHE_EXPORT_BUS_CANDIDATE_KEYS;
    private static final ModConfigSpec.BooleanValue COALESCE_CLIENT_TERMINAL_VIEW_UPDATES;
    private static final ModConfigSpec.BooleanValue ASYNC_TERMINAL_SEARCH_SORT;
    private static final ModConfigSpec.IntValue ASYNC_TERMINAL_MINIMUM_ENTRIES;
    private static final ModConfigSpec.BooleanValue FIX_STUCK_AE2_SCROLLBAR_REPEAT;
    ...
    private static final ModConfigSpec.BooleanValue THROTTLE_STORAGE_WATCHER_UPDATES;
    private static final ModConfigSpec.IntValue STORAGE_WATCHER_UPDATE_INTERVAL_TICKS;
    private static final ModConfigSpec.BooleanValue THROTTLE_TERMINAL_INVENTORY_SNAPSHOTS;
    private static final ModConfigSpec.IntValue TERMINAL_INVENTORY_SNAPSHOT_INTERVAL_TICKS;
    private static final ModConfigSpec.BooleanValue CACHE_TERMINAL_CRAFTABLES;
    private static final ModConfigSpec.IntValue TERMINAL_CRAFTABLE_CACHE_TICKS;
    private static final ModConfigSpec.BooleanValue FLUSH_IMMEDIATELY_ON_SCREEN_OPEN;
    private static final ModConfigSpec.BooleanValue FLUSH_IMMEDIATELY_ON_CELL_CHANGE;
    private static final ModConfigSpec.BooleanValue FLUSH_IMMEDIATELY_ON_NETWORK_TOPOLOGY_CHANGE;
    private static final ModConfigSpec.IntValue MAXIMUM_BUFFERED_CHANGES;
    private static final ModConfigSpec.BooleanValue ENABLE_DEEP_AE2_REWRITE_FLAGS;
    private static final ModConfigSpec.BooleanValue DEEP_PATTERN_SELECTION_BY_AVAILABILITY;
    private static final ModConfigSpec.IntValue DEEP_PATTERN_SELECTION_MAXIMUM_CANDIDATES;
    private static final ModConfigSpec.BooleanValue DEEP_NETWORK_FORCE_UPDATE_COALESCING;
    private static final ModConfigSpec.IntValue DEEP_NETWORK_UPDATE_INTERVAL_TICKS;
    private static final ModConfigSpec.BooleanValue DEEP_VISIBLE_TERMINAL_RANGE_SYNC;
    private static final ModConfigSpec.IntValue DEEP_TERMINAL_RANGE_ENTRIES_PER_TICK;
    private static final ModConfigSpec.BooleanValue DEEP_P2P_TOPOLOGY_CHANGE_ONLY_RECHECK;
    private static final ModConfigSpec.IntValue DEEP_P2P_DUPLICATE_WINDOW_TICKS;
    private static final ModConfigSpec.BooleanValue DEEP_BUS_SEARCH_REWRITE;
    private static final ModConfigSpec.IntValue DEEP_BUS_FUZZY_CACHE_TICKS;
    private static final ModConfigSpec.IntValue DEEP_BUS_FUZZY_CACHE_SIZE;
    private static final ModConfigSpec.BooleanValue DEEP_FLUID_PATTERN_REWORK;
    private static final ModConfigSpec.BooleanValue LOG_DEEP_AE2_REWRITE_FLAGS;
    ...
    private static final ModConfigSpec.BooleanValue ENABLE_PATTERN_MICRO_BATCHING;
    private static final ModConfigSpec.IntValue MAX_PATTERN_EXECUTIONS_PER_MICRO_BATCH;
    private static final ModConfigSpec.BooleanValue REQUIRE_SINGLE_PATTERN_PROVIDER_TARGET;
    private static final ModConfigSpec.ConfigValue<List<? extends String>> PATTERN_MICRO_BATCH_TARGET_NAMESPACES;
    private static final ModConfigSpec.BooleanValue ENABLE_TRANSACTIONAL_PATTERN_BATCHING;
    private static final ModConfigSpec.IntValue MAX_TRANSACTIONAL_PATTERN_BATCH_EXECUTIONS;
    private static final ModConfigSpec.BooleanValue ENABLE_SEQUENTIAL_PATTERN_PROVIDER_BATCH_ADAPTER;
    private static final ModConfigSpec.IntValue MAX_SEQUENTIAL_PROVIDER_EXECUTIONS_PER_CALL;
    ...
    private static final ModConfigSpec.ConfigValue<List<? extends String>> TRANSACTIONAL_BATCH_TARGET_NAMESPACES;
    ...
    private static final ModConfigSpec.BooleanValue ENABLE_CREATE_RECIPE_INTENT_FAST_PATH;
    ...
    private static final ModConfigSpec.BooleanValue REQUIRE_AQE_BIG_PLAN_SHADOW_QUALIFICATION;
    ...
    private static final ModConfigSpec.BooleanValue ENABLE_GTCEU_NATIVE_BATCHING;
    private static final ModConfigSpec.BooleanValue ENABLE_MEKANISM_NATIVE_BATCHING;
    private static final ModConfigSpec.BooleanValue ENABLE_FAIR_CRAFTING_JOB_SCHEDULER;
    private static final ModConfigSpec.IntValue FAIR_SCHEDULER_OPERATIONS_PER_TICK;
    private static final ModConfigSpec.IntValue FAIR_SCHEDULER_QUANTUM;
    private static final ModConfigSpec.IntValue FAIR_SCHEDULER_TIME_BUDGET_MILLIS;
    ...
    private static final ModConfigSpec.IntValue BIG_INTEGER_MAXIMUM_WINDOW_CALCULATIONS_PER_TICK;
    private static final ModConfigSpec.IntValue BIG_INTEGER_RETRY_BACKOFF_TICKS;
    ...
    private static final ModConfigSpec.BooleanValue ENABLE_AQE_BIG_INTEGER_VECTOR_PARENTS;
    ...
    static {
        ...
        CACHE_ADJACENT_CAPABILITY_LOOKUPS = builder
                .comment("Compatibility key. The cross-tick BlockApiCache replacement was removed in 1.2.2; NeoForge and AE2 retain capability ownership.")
