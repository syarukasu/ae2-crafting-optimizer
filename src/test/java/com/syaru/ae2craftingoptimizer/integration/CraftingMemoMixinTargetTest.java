...
class CraftingMemoMixinTargetTest {
    @Test
    void taggedValidationTargetsKeepTheVanillaRecipeEvaluationBoundary() throws Exception {
        var pattern = appeng.crafting.pattern.AECraftingPattern.class;
        assertEquals(net.minecraft.world.item.crafting.CraftingRecipe.class,
                pattern.getDeclaredField("recipe").getType());
        assertEquals(Boolean.class, method(pattern, "getTestResult", int.class,
                appeng.api.stacks.AEItemKey.class).getReturnType());
        assertEquals(void.class, method(pattern, "setTestResult", int.class,
                appeng.api.stacks.AEItemKey.class, boolean.class).getReturnType());
        assertEquals(1, calls("appeng/crafting/pattern/AECraftingPattern", "isItemValid",
                "appeng/crafting/pattern/AECraftingPattern", "getTestResult",
                "(ILappeng/api/stacks/AEItemKey;)Ljava/lang/Boolean;"));
        assertEquals(1, calls("appeng/crafting/pattern/AECraftingPattern", "isItemValid",
                "appeng/crafting/pattern/AECraftingPattern", "setTestResult",
                "(ILappeng/api/stacks/AEItemKey;Z)V"));
    }
