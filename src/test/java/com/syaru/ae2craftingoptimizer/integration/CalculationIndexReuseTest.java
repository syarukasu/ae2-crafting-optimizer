...
class CalculationIndexReuseTest {
    ...
    @BeforeEach void setup() throws Exception {
        ...
        enabled = (ForgeConfigSpec.BooleanValue) field(ACOConfig.class, "MEMOIZE_CRAFTING_CALCULATION_QUERIES").get(null);
    }
    ...
    private static final class TestKey extends AEKey {
        ...
        @Override public ResourceLocation getId() { return new ResourceLocation("aco", "test"); }
